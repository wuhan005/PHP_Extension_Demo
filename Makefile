srcdir = /home/parallels/php/php-7.2.20-ext/ext/Eggplant
builddir = /home/parallels/php/php-7.2.20-ext/ext/Eggplant
top_srcdir = /home/parallels/php/php-7.2.20-ext/ext/Eggplant
top_builddir = /home/parallels/php/php-7.2.20-ext/ext/Eggplant
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--with-php-config=/usr/local/php7-ext/bin/php-config'
CONFIGURE_OPTIONS = '--with-php-config=/usr/local/php7-ext/bin/php-config'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = nawk
shared_objects_Eggplant = Eggplant.lo
PHP_PECL_EXTENSION = Eggplant
PHP_MODULES = $(phplibdir)/Eggplant.la
PHP_ZEND_EX =
all_targets = $(PHP_MODULES) $(PHP_ZEND_EX)
install_targets = install-modules install-headers
prefix = /usr/local/php7-ext
exec_prefix = $(prefix)
libdir = ${exec_prefix}/lib
prefix = /usr/local/php7-ext
phplibdir = /home/parallels/php/php-7.2.20-ext/ext/Eggplant/modules
phpincludedir = /usr/local/php7-ext/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /usr/local/php7-ext/lib/php/extensions/no-debug-non-zts-20170718
PHP_EXECUTABLE = /usr/local/php7-ext/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/usr/local/php7-ext/include/php -I/usr/local/php7-ext/include/php/main -I/usr/local/php7-ext/include/php/TSRM -I/usr/local/php7-ext/include/php/Zend -I/usr/local/php7-ext/include/php/ext -I/usr/local/php7-ext/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
